...
class VQAFeatureDataset(Dataset):
    def __init__(self, name, dictionary, dataroot='../GGE-main/data', dataset='cpv2',
        ...
        if dataset=='cpv2':
            ...
            with open('../GGE-main/util/cpv2_type_mask.json', 'r') as f:
                self.type_mask = json.load(f)
            with open('../GGE-main/util/cpv2_notype_mask.json', 'r') as f:
                self.notype_mask = json.load(f)

        elif dataset=='cpv1':
            with open('../GGE-main/data/hints/train_cpv1_hintscore.json', 'r') as f:
                self.train_hintscore = json.load(f)
            with open('../GGE-main/data/test_cpv1_hintscore.json', 'r') as f:
                self.test_hintscore = json.load(f)
            with open('../GGE-main/util/cpv1_type_mask.json', 'r') as f:
                self.type_mask = json.load(f)
            with open('../GGE-main/util/cpv1_notype_mask.json', 'r') as f:
                self.notype_mask = json.load(f)
        elif dataset=='v2':
            with open('../GGE-main/data/hints/train_v2_hintscore.json', 'r') as f:
                self.train_hintscore = json.load(f)
            with open('../GGE-main/data/hints/test_v2_hintscore.json', 'r') as f:
                self.test_hintscore = json.load(f)
            with open('../GGE-main/util/v2_type_mask.json', 'r') as f:
                self.type_mask = json.load(f)
            with open('../GGE-main/util/v2_notype_mask.json', 'r') as f:
                self.notype_mask = json.load(f)
            ...
            for entry in tqdm(self.entries, ncols=100, desc="caching-features"):
                ...
                if img_id not in image_to_fe:
                    ...
                    if use_hdf5:
                        ...
                        fe=torch.load('../GGE-main/data/rcnn_feature/'+str(img_id)+'.pth')['image_feature']
    ...
    def __getitem__(self, index):
        ...
        if self.image_to_fe is not None:
            ...
            features = torch.load('../GGE-main/data/rcnn_feature/' + str(entry["image_id"]) + '.pth')['image_feature']
