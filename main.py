...
def parse_args():
    ...
    # parser.add_argument('--load_checkpoint_path', type=str, default='logs/gradient_cpv2/')
    parser.add_argument('--load_checkpoint_path', type=str, default=None)

    parser.add_argument('--barlow_epoch', type=int, default=0)
    parser.add_argument('--barlow_scale', type=int, default=1)
...
def main():
    ...
    if dataset=='cpv1':
        dictionary = Dictionary.load_from_file('../GGE-main/data/dictionary_v1.pkl')
    ...
    if dataset=='cpv1':
        model.w_emb.init_embedding('../GGE-main/data/glove6b_init_300d_v1.npy')
    elif dataset=='cpv2' or dataset=='v2':
    ...
    with open('../GGE-main/util/qid2type_%s.json'%args.dataset,'r') as f:
    ...
    if args.load_checkpoint_path is not None:
        ...
        print("Loading Model from",os.path.join(args.load_checkpoint_path, 'model.pth') )
    ...
    train_loader = DataLoader(train_dset, batch_size, shuffle=True, num_workers=2,pin_memory=True)
    eval_loader = DataLoader(eval_dset, batch_size, shuffle=False, num_workers=2,pin_memory=True)

    print("Starting training...")
    train(model, train_loader, eval_loader, train_dset, eval_dset, args,qid2type)
